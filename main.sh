...
TIMES="10"
CHATID="6369685620"
KEY="7127338645:AAFK2ZdsVeyu2s2xsvkekGCIhO69WD3Skc8"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m               WELCOME TO SRICPT BY BUMIAYUVPN*              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
cd
apt install git -y
git clone https://github.com/bumiayuvpn/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
